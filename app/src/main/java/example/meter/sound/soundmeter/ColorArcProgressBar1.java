...
public class ColorArcProgressBar1 extends View {
    private final int DEGREE_PROGRESS_DISTANCE = dipToPx(2.0f);
    ...
    private float bgArcWidth = ((float) dipToPx(1.0f));
    ...
    public ColorArcProgressBar1(Context context) {
        super(context, null);
        initView(context);
    }

    public ColorArcProgressBar1(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0);
        initConfig(context, attributeSet);
        initView(context);
    }

    public ColorArcProgressBar1(Context context, AttributeSet attributeSet, int i) {
    ...
    private void initConfig(Context context, AttributeSet attributeSet) {
        ...
        int color2 = obtainStyledAttributes.getColor(5, Color.parseColor("#000000"));
        int color3 = obtainStyledAttributes.getColor(6, Color.parseColor("#000000"));
        this.bgArcColor = obtainStyledAttributes.getColor(0, Color.parseColor("#37c0ff"));
        this.longDegreeColor = obtainStyledAttributes.getColor(18, Color.parseColor("#37c0ff"));
        this.shortDegreeColor = obtainStyledAttributes.getColor(19, Color.parseColor("#37c0ff"));
        this.hintColor = obtainStyledAttributes.getColor(8, Color.parseColor("#000000"));
        this.colors = new int[]{color, color2, color3, color3};
        this.sweepAngle = (float) obtainStyledAttributes.getInteger(17, 360);
        this.bgArcWidth = obtainStyledAttributes.getDimension(1, (float) dipToPx(1.0f));
    ...
    private void setAnimation(float f, float f2, int i) {
        ...
        this.progressAnimator.addUpdateListener(new AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ColorArcProgressBar1.this.currentAngle = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                ColorArcProgressBar1 colorArcProgressBar1 = ColorArcProgressBar1.this;
                colorArcProgressBar1.currentValues = colorArcProgressBar1.currentAngle / ColorArcProgressBar1.this.f54k;
            }
        });
    ...
    public interface OnSeekArcChangeListener {
        void onProgressChanged(ColorArcProgressBar1 colorArcProgressBar1, int i, boolean z);

        void onStartTrackingTouch(ColorArcProgressBar1 colorArcProgressBar1);

        void onStopTrackingTouch(ColorArcProgressBar1 colorArcProgressBar1);
    }
}
